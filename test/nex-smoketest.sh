...
echo "=== Creating a product id: another_product ==="
curl -s -XPOST  "${STD_APP_URL}/products" \
    -H 'accept: application/json' \
    -H 'Content-Type: application/json' \
    -d '{"id": "another_product", "title": "Another Product", "passenger_capacity": 10, "maximum_speed": 8, "in_stock": 15}'
echo
...
# Test: Delete Product
echo "=== Delete Product id: another_product ==="
curl -s -XDELETE "${STD_APP_URL}/products/another_product"
echo
